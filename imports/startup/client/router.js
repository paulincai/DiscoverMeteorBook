...
const HomePage = loadable(() => import('../../ui/common/pages/HomePage'))
const AdminPurchasesPage = loadable(() => import('../../ui/admin/pages/AdminPurchasesPage'))
const AdminUsersPage = loadable(() => import('../../ui/admin/pages/AdminUsersPage'))

export default function Main (props, location) {
  return (
...
FlowRouter.route('/admin/purchases', {    // DONE
